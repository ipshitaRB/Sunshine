...
public class TestDb extends AndroidTestCase {
    ...
    */
    public void testLocationTable() {
        ...
        assertTrue(insertLocation(db, testValues)!= -1);
    ...
    public void testWeatherTable() {
        ...
        assertTrue("Error : no records from weather query", cursor.moveToFirst());
        // Move the cursor to a valid database row
    ...
    public long insertLocation(SQLiteDatabase db, ContentValues testValues) {
        ...
        // Insert ContentValues into database and get a row ID back
        long locaationRowId;
        locaationRowId = db.insert(WeatherContract.LocationEntry.TABLE_NAME, null, testValues);
        return locaationRowId;
    }
}
